...
% dimensions and number of atoms and type: octave_ljmd()
 ...
 sys.nsteps = 100;                % number of MD timesteps
 sys.dt = 5.0;                      % Timesteps in fs
 nprint = 10;                     % Output Frequency (number of MD steps)

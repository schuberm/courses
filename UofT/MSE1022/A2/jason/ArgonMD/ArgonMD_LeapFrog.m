...
props(1,1:6)=0;                     % properties to save
...
if RESTART==1   
    ...
    %set initial coordinate to measure mean square displacement
    x_0=x;
    x_p=x;
else
    %read_data
...
[x,x_p]=position_leapfrog(N,t_step,x,x_p,p_half,p,m,L,tau_p,eps_p,P,Pset);
...
str = 'D:\Classes\CMU\MD\HW5\Problem 2\Part c\20K\';
    dlmwrite(strcat(str,'x.dat'),x);
